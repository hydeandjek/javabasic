...
static Random r = new Random();
    ...
    //당첨 등수를 알려주는 메서드
    public static void checkLottoNumber(Set<Integer>nums,Set<Integer>myLotto,int bonus ) {
        /*
...
//로또 번호 생성 메서드를 호출해서 당첨 번호를 하나 고정시키세요.
    	Set<Integer> nums = createLotto();
        //보너스번호도 하나 고정시키세요.
    	int bonus = createBonusNum(nums);
        ...
        while(true) {
        	...
        	checkLottoNumber(nums,myLotto,bonus);
        	
        	if(prize1==1) {
        		System.out.println("축하합니다 1등입니다.");
        		System.out.printf("누적 당첨 횟수\n2등 : %d회\n3등 : %d회\n4등 : %d회\n5등 : %d회\n꽝 : %d회",prize1,prize2,prize3,prize4,prize5,failCnt);
        		System.out.println("로또 구입한 장수 : "+paper+"장");
        		System.out.println("로또 구압한 총 비용 : "+cost+"원");
        		break;
        	}else {
        		System.out.println("로또 " +paper+"장째 구매중");
        	}
