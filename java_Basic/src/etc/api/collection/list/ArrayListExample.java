...
//		String name = nick[3];(x) 배열의 방법이므로 불가능
		...
		/*
		 # 컬랙션 객체들은 Collections 의 기능을 사용할 수 있습니다.
		 Collections는 컬랙션 객체들의 부가 가능을 지원합니다. 
		 */
		...
		//한번에 객체 많이 추가하기
		Collections.addAll(Score, 78,88,79,100,21,56,100);
