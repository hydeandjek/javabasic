...
public class HashMapExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		//Map은 key,Value 쌍을 이루기 떄문에 멀티 제네릭을 설정
		...
		map.put("멍멍이","김뽀삐");//멍멍이라는 key중복
		map.put("어흥이", "홍길동");//vlaue중복
		System.out.println(map);
		
		//map내부에 키의 존재 유무를 확인하는 메서드 : containsKey(key)
		...
		if(map.containsKey(name)) {
			...
			System.out.println("그런별명 가진 사람 없습니다.");
		}
