...
public class MyBirth {
	...
	/*
	 ...
	 -따라서 데이터의 유효성을 검증할 수 있는 제어문이 포함된 메서드를 사용하여
	 데이터의 접근을 허용하도록 설계하는데, 이때 사용하는 메서드를
	 getter/ setter메서드라고 부른다.
    ...
    */
	...
	public void birthInfo() {
		...
		//출력 하지 않겠다.
		if(getDay() == 0 || getYear() == 0 ||getMonth() ==0) {
	...
	/*
	 ...
	 캡슐화 라고한다. (encapsulation)
	 데이터와 그 데이터를 다루는 로직을 하나로 묶어 쉽게 관리하고 유지보수하기 위함이다.
