		...
		while (true) {
            ...
            if(menu == 1) {
            	...
            	for (int i =0; i<count ;i++) {
            		...
            		if(!flag) {
            			System.out.println("조회하실 사원의 정보가 없습니다.");
            		}
            	}
            }else if (menu ==4) {
            	...
            	System.out.println("수정하실 사원의 사번을 입려갛세요 : ");
            	System.out.println("> ");
            	String empNum = sc.next();
            			...
            			menu4: while(true) {
            				...
            				switch(sel){
            					...
            					case 3 :
            						...
            						break menu4;
            					default : 
            						System.out.println("변경 메뉴를 잘못 입력 하셧습니다.");
